...
RV64 开发已完成 **RV64-M2**：新增独立 RV64I 核心、RV64M 乘除法、
RV64 Machine、运行时 CPU 选择和 RV64IM/LP64 裸机入口。RV64 的 A/C
扩展、特权态、Sv39 和 OpenSBI/Linux 启动属于后续阶段，当前不能用
RV64 启动 Linux。
...
```text
core/          自研 CPU 核心
core64/        独立 RV64IM CPU 核心及 RV64 实施计划
