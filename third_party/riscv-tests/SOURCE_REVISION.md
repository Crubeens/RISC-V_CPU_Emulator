...
The vendored files are limited to the RV32 I/M/A/C and RV64 F/D
physical-environment instruction tests, their shared source bodies, scalar
macros, encoding definitions, linker environment, and BSD license. The
project supplies its own linker layouts and runners under
`tests/architecture32` and `tests/architecture64`.
